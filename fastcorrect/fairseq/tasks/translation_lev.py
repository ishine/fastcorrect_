...
# translation_lev task has been replaced by FastCorrect
...
class TranslationLevenshteinTask(TranslationTask):
    ...
    def build_dataset_for_inference(self, src_tokens, src_lengths, nbest_infer=0, constraints=None, break_alignment=False):
